<template>
    <div>
      ...
      <div
        style="display: flex; justify-content: flex-end; align-items: center; margin-top: -140px"
      >
        <div id="ship">
          <div class="active" @click="goToHome">Home</div>
          <div></div>
          <div>{{ greeting }}</div>
          <div></div>
          <div @click="goToSearch">SEARCH</div>
        </div>
...
import jwtDecode from 'jwt-decode';  
  ...
  export default class Navbar extends Vue {
    ...
    get greeting(): string {
      return this.token ? `You're welcome ${this.name}` : 'LOG IN';
    }
